...
public class StudentController {
    ...
    public ResponseEntity<Student> createStudent(@RequestBody Student student){
        ...
        Student createdStudent = studentService.createStudent(student);/*return ResponseEntity.ok(createdStudent);*//*return ResponseEntity.status(201).body(createdStudent);*/
